...
if (isset($_POST['tambah'])) {
    ...
    if($sql) {
        echo "<script>alert('Data berhasil disimpan'); location.href='../users/foto.php';</script>";
    } else {
...
if(isset($_POST['edit'])){
    ...
    if($sql) {
        echo "<script>alert('Data berhasil diedit'); location.href='../users/foto.php';</script>";
    } else {
...
if(isset($_POST['hapus'])){
    ...
    if($query) {
        echo "<script>alert('Data berhasil dihapus'); location.href='../users/foto.php';</script>";
    } else {
